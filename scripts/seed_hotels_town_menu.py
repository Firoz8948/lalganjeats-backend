...
"""
Create/update Hotels Town Restaurant's menu.
...
Run on EC2 inside the backend container:
    docker compose exec backend python -m scripts.seed_hotels_town_menu

Preview without changing the database:
    docker compose exec backend python -m scripts.seed_hotels_town_menu --dry-run
"""
...
RESTAURANT_NAME = "Hotels Town Restaurant"
TENANT_SLUG = "lalganj"
...
SUBCATEGORIES = {
    "tandoori-special": "Tandoori Special",
...
# Descriptions are intentionally left blank because the supplied menu images
# provide item names and prices, but no item descriptions.
ITEMS = [
    # Tandoori Special
    item("Tandoori khazana", "", "460", "tandoori-special", False),
    item("Spl Chicken tandoori", "", "450", "tandoori-special", False),
    item("Italian tandoori", "", "495", "tandoori-special", False),
    item("Afghani tandoori", "", "460", "tandoori-special", False),
    item("Malai tandoori", "", "450", "tandoori-special", False),
    item("Peswari tandoori", "", "350", "tandoori-special", False),
    item("Chicken tikka", "", "300", "tandoori-special", False),
    item("Charsi mutton", "", "600", "tandoori-special", False),
    item("Chicken barra tandoori", "", "460", "tandoori-special", False),
    item("Malai tikka", "", "200", "tandoori-special", False),
    item("Afghani tikka", "", "300", "tandoori-special", False),
    item("Rejali tikka", "", "299", "tandoori-special", False),
    item("Haryali tikka", "", "250", "tandoori-special", False),
    item("Payari tikka", "", "230", "tandoori-special", False),
    item("Peswari tikka", "", "300", "tandoori-special", False),

    # Main Course Chicken
    item_named(
        "Murgh musallam", "", "main-course-chicken", False,
        ("Full", "700"), ("Half", "350"),
    ),
    item("Lucknow handi", "", "260", "main-course-chicken", False),
    item("Tawa kunchan", "", "230", "main-course-chicken", False),
    item("Chicken bunna goat", "", "240", "main-course-chicken", False),
    item("Butter chicken", "", "260", "main-course-chicken", False),
    item("Chicken tikka masala", "", "280", "main-course-chicken", False),
    item("Murgh matka", "", "250", "main-course-chicken", False),
    item("Chicken lawabdar", "", "270", "main-course-chicken", False),
    item("Peswari handi", "", "280", "main-course-chicken", False),
    item("Kadhi chicken masala", "", "260", "main-course-chicken", False),
    item("Chicken do payza", "", "250", "main-course-chicken", False),

    # Chicken
    item("Chicken fried rice", "", "140", "chicken", False),
    item("Chicken serwan fried rice", "", "145", "chicken", False),
    item("Chicken singapuri fried rice", "", "160", "chicken", False),
    item("Chicken triple fried rice", "", "220", "chicken", False),
    item("Egg fried rice", "", "120", "chicken", False),
    item("Egg sezwan fried rice", "", "130", "chicken", False),
    item("Chickon Hong Kong fried rice", "", "220", "chicken", False),
    item("Chicken garlic fried rice", "", "160", "chicken", False),
    item("Chicken Biryani rice", "", "120", "chicken", False),
    item("Khuska rice", "", "110", "chicken", False),
    item("Jeera rice", "", "110", "chicken", True),
    item("Ghee rice", "", "140", "chicken", True),
    item("Plane rite", "", "100", "chicken", True),

    # Mutton
    item("Mutton bhuna ghost", "", "350", "mutton", False),
    item("Mutton masala", "", "370", "mutton", False),
    item("Mutton do payza", "", "320", "mutton", False),
    item("Mutton lawabdar", "", "360", "mutton", False),
    item("Mutton kadhai Masala", "", "340", "mutton", False),
    item("Peswari mutton handi", "", "380", "mutton", False),
    item("Spl mution handi", "", "400", "mutton", False),

    # Chinese Starter
    item("Chicken crispy", "", "260", "chinese-starter", False),
    item("Chicken chilli dry", "", "240", "chinese-starter", False),
    item("Chicken chanadon 6pc lollipop", "", "230", "chinese-starter", False),
    item("Chicken lollipop 6 pc", "", "160", "chinese-starter", False),
    item("Chicken fry", "", "200", "chinese-starter", False),
    item("Chicken 65", "", "200", "chinese-starter", False),
    item("Chicken Butter garlic", "", "220", "chinese-starter", False),
    item("Chicken garlic lollipop dry 6 pc", "", "250", "chinese-starter", False),
    item("Chicken manchurian dry", "", "240", "chinese-starter", False),
    item("Chicken smoke chilli", "", "210", "chinese-starter", False),
    item("Lemon chicken sizzler", "", "260", "chinese-starter", False),
    item("Chicken platter", "", "2100", "chinese-starter", False),

    # Noodles
    item("Chicken Hakka noodles", "", "180", "noodles", False),
    item("Chicken sezwan noodles", "", "200", "noodles", False),
    item("Hakka noodles", "", "150", "noodles", True),
    item("Egg Hakka noodles", "", "150", "noodles", False),
    item("Egg Hakka Schezwan noodles", "", "150", "noodles", False),
    item("Veg noodles", "", "130", "noodles", True),

    # Soup
    item("Chicken manchow soup", "", "110", "soup", False),
    item("Lemon kalandar soup", "", "100", "soup", True),
    item("Chicken haunted shower soup", "", "140", "soup", False),
    item("Veg manchow soup", "", "90", "soup", True),
    item("Finger chips", "", "150", "soup", True),
    item("Honey chilli potato", "", "200", "soup", True),
    item("Singer cheese Peri Peri", "", "180", "soup", True),

    # Salad & Papad
    item("Green salad", "", "50", "salad-papad", True),
    item("Masala papad", "", "60", "salad-papad", True),
    item("Roasted papad", "", "30", "salad-papad", True),
    item("Roasted masala papad", "", "70", "salad-papad", True),

    # Egg & Roll Items
    item("Double egg omlette", "", "50", "egg-roll-items", False),
    item("Single egg omelette", "", "30", "egg-roll-items", False),
    item("Double egg bhurji", "", "60", "egg-roll-items", False),
    item("Single egg bhurji", "", "35", "egg-roll-items", False),

    # Roti
    item("Roti", "", "12", "roti", True),
    item("Butter roti", "", "18", "roti", True),
    item("Naan", "", "25", "roti", True),
    item("Butter naan", "", "35", "roti", True),
    item("Garlic naan", "", "40", "roti", True),
    item("Lacha paratha", "", "40", "roti", True),
    item("Kulcha", "", "20", "roti", True),
    item("Butter kulcha", "", "35", "roti", True),
    item("Khamira naan", "", "50", "roti", True),
]
...
def find_restaurant(db) -> Restaurant:
    ...
    candidates = (
        ...
        .filter(
            ...
            Restaurant.name.ilike("%Hotel%Town%"),
        )
        .all()
    )
